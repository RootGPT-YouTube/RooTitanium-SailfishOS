...
Window {
    ...
    // Quanto scendono i pallini di selezione sotto il bordo inferiore della
    // selezione, in px della view: 24 (immagine) + 2 (offset verticale), valori
    // fissi di Chromium (touch_handle_drawable_qt.cpp) verificati sul device.
    ...
    readonly property string appVersion: "1.8"
    ...
    property bool cfgDnt: true              // Non tenere traccia (default dal 17 set)
    ...
    // referrer e storage 3P restano spenti (noreferrer rompe i captcha).
    // Indipendenti fra loro, nessun toggle master.
    property bool cfg3pCookies: true        // blocca i cookie di terze parti
    ...
    function loadCfg() {
        ...
        cfg3pCookies    = kvGet("set_3pcookies", "1") === "1"
  ...
  window.__rtSelApply = function(i){
    ...
    function loadInternalStart(view, kind) {
        ...
        else if (kind === "about") loadInternal(view, "about", aboutHtml(), "https://about.local/")
    }
...
<a class="srow" href="https://about.local/"><span class="sbody"><span class="st">${win.t("Informazioni su RooTitanium", "About RooTitanium")}</span><span class="sd">${win.t("Versione, crediti e licenza", "Version, credits and license")}</span></span><span class="chev">›</span></a>
    ...
    // ===================== INFORMAZIONI (About) =====================
    // Pagina interna in stile RooTelegram: avatar RootGPT, nome+versione, crediti
    // e licenze. L'avatar è incorporato come data URI (WebP ~5KB) così renderizza
    // dentro la pagina https://about.local/ senza dipendere da uno schema/file
    // esterno (le pagine interne bloccano i fetch a schema custom). I link esterni
    // (github, chromium…) NON sono *.local, quindi navigano normalmente al sito.
    readonly property string aboutAvatar: "data:image/webp;base64,"
    function aboutHtml() {
        var repo = "https://github.com/RootGPT-YouTube/RooTitanium-SailfishOS"
        return `<!doctype html><html><head><meta name="viewport" content="width=device-width,initial-scale=1,user-scalable=no"><title>${win.t("Informazioni su RooTitanium", "About RooTitanium")}</title><style>${win.themeVars()}
*{box-sizing:border-box} body{background:var(--bg);color:var(--fg);font-family:sans-serif;margin:0;padding:26px 22px 40px;text-align:center;line-height:1.5}
.htitle{color:var(--accent);font-size:19px;font-weight:600;margin:0 0 22px}
.avatar{width:180px;height:180px;border-radius:50%;object-fit:cover;display:block;margin:0 auto 18px}
.name{font-size:26px;font-weight:400;margin:0 0 10px}
.sub{font-size:14px;margin:0 0 6px}
.by{color:var(--muted);font-size:13px;margin:0 auto 16px;max-width:26em}
a{color:var(--link);text-decoration:none}
.lnk{display:block;font-size:14px;margin:9px 0}
hr{border:0;border-top:1px solid var(--line);margin:24px 0}
.lic{font-size:14px;margin:0 0 4px}
h2{color:var(--accent);font-size:14px;font-weight:600;margin:28px 0 12px}
.cr{font-size:13px;margin:0 auto 4px;max-width:30em}
.crlnk{display:block;font-size:13px;margin:2px 0 16px}
.foot{color:var(--muted);font-size:12px;margin-top:24px}
</style></head><body>
<div class="htitle">${win.t("Informazioni su RooTitanium", "About RooTitanium")}</div>
<img class="avatar" src="${win.aboutAvatar}" alt="RootGPT">
<div class="name">RooTitanium ${win.appVersion}</div>
<div class="sub">${win.t("Un browser Qt6 WebEngine per Sailfish OS", "A Qt6 WebEngine browser for Sailfish OS")}</div>
<div class="by">${win.t("di RootGPT, con Claude (Anthropic)", "by RootGPT, with Claude (Anthropic)")}</div>
<a class="lnk" href="${repo}">${win.t("Codice sorgente su GitHub", "Source code on GitHub")}</a>
<hr>
...
(function(){
  ...
  document.addEventListener('click', function(e){
    ...
    Component.onCompleted: {
        // NB: NON chiamare win.showFullScreen() qui. In 1.4 forzava un
        // set_fullscreen Wayland *reale* per rimediare alla fascia nera su X10 III
        // (compositor che degrada il FullScreen dichiarativo a Maximized), ma su
        // X10 II (Adreno 508) la riconfigurazione della surface faceva perdere il
        // buffer alla subsurface di QtWebEngine → schermo nero dopo il primo frame
        // (report teirdes, 5.1.0.11). Ripristinato il solo FullScreen dichiarativo
        // (visibility: Window.FullScreen) come in 1.3: la fascia nera cosmetica su
        // certi X10 III è preferibile al browser inutilizzabile su X10 II.
        loadCfg()
        applyClientHints()
            ...
            Repeater {
                ...
                WebEngineView {
                    ...
                    onNavigationRequested: function(request) {
                        ...
                        } else if (u.indexOf("https://about.local/") === 0) {
                            request.action = WebEngineNavigationRequest.IgnoreRequest
                            win.loadInternal(this, "about", win.aboutHtml(), "https://about.local/")
                        }
                    }
    ...
    // Strato che chiude il menù contestuale toccando fuori. Copre tutto lo
    // schermo, sta sopra la pagina e finché è attivo la pagina non riceve nulla.
    //
    // ⚠️ Col menù della SELEZIONE TOUCH quel comportamento è sbagliato due volte:
    // il tocco sul pallino moriva qui (il menù si chiudeva e Chromium non vedeva
    // mai il press → il pallino non si agganciava al dito), e il tocco fuori
    ...
    // per sbaglio il link che c'è sotto.
    MouseArea {
        ...
        onPressed: function(mouse) {
            if (ctxMenu.touchSel) {
                ...
                Qt.callLater(function() { ctxMenu.open = false })
                return
            }
            ctxMenu.open = false
        }
        onClicked: ctxMenu.open = false
        onPressAndHold: ctxMenu.open = false
    }
    ...
    Rectangle {
        ...
        property real px: 0
        property real py: 0
        // true = è il menù della selezione touch (non quello di longpress):
        // lo strato di chiusura si comporta in modo diverso, vedi sotto
        property bool touchSel: false
        width: 320 * win.u
